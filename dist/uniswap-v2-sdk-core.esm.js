...
var FACTORY_ADDRESSES =
  ((_FACTORY_ADDRESSES = {}), (_FACTORY_ADDRESSES[ChainId.SEPOLIA] = SEPOLIA_ADDRESSES.FACTORY), _FACTORY_ADDRESSES)
var ROUTER_ADDRESSES =
  ((_ROUTER_ADDRESSES = {}), (_ROUTER_ADDRESSES[ChainId.SEPOLIA] = SEPOLIA_ADDRESSES.ROUTER02), _ROUTER_ADDRESSES)
...
var Token = /*#__PURE__*/ (function(_BaseCurrency) {
  ...
  function Token(chainId, address, decimals, symbol, name, bypassChecksum, buyFeeBps, sellFeeBps) {
    ...
    if (buyFeeBps) {
      !buyFeeBps.gte(BigNumber.from(0))
        ? process.env.NODE_ENV !== 'production'
          ? invariant(false, 'NON-NEGATIVE FOT FEES')
          : invariant(false)
        : void 0
    }
    if (sellFeeBps) {
      !sellFeeBps.gte(BigNumber.from(0))
        ? process.env.NODE_ENV !== 'production'
          ? invariant(false, 'NON-NEGATIVE FOT FEES')
          : invariant(false)
        : void 0
 ...
 */
function sqrt(value) {
  !JSBI.greaterThanOrEqual(value, ZERO$1)
    ? process.env.NODE_ENV !== 'production'
...
var Pair = /*#__PURE__*/ (function() {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    !factoryAddress
      ? process.env.NODE_ENV !== 'production'
        ? invariant(false, 'FACTORY_ADDRESS')
        : invariant(false)
      : void 0
...
function sortTokens(tokenA, tokenB) {
  !(tokenA !== tokenB)
    ? process.env.NODE_ENV !== 'production'
      ? invariant(false, 'IDENTICAL_ADDRESSES')
      : invariant(false)
    : void 0
...
function quote(amountA, reserveA, reserveB) {
  !JSBI.greaterThan(amountA, JSBI.BigInt(0))
    ? process.env.NODE_ENV !== 'production'
      ? invariant(false, 'INSUFFICIENT_AMOUNT')
      : invariant(false)
    : void 0
...
function getAmountOut(amountIn, reserveIn, reserveOut) {
  !JSBI.greaterThan(amountIn, JSBI.BigInt(0))
    ? process.env.NODE_ENV !== 'production'
      ? invariant(false, 'INSUFFICIENT_INPUT_AMOUNT')
      : invariant(false)
    : void 0
...
function getAmountIn(amountOut, reserveIn, reserveOut) {
  !JSBI.greaterThan(amountOut, JSBI.BigInt(0))
    ? process.env.NODE_ENV !== 'production'
      ? invariant(false, 'INSUFFICIENT_OUTPUT_AMOUNT')
      : invariant(false)
    : void 0
  !(JSBI.greaterThan(reserveIn, JSBI.BigInt(0)) && JSBI.greaterThan(reserveOut, JSBI.BigInt(0)))
    ? process.env.NODE_ENV !== 'production'
          ...
          return _regenerator().w(
            function(_context8) {
              while (1)
                switch (_context8.n) {
                  case 0:
                    !JSBI.greaterThanOrEqual(offset, JSBI.BigInt(0))
                      ? process.env.NODE_ENV !== 'production'
                        ? invariant(false, 'INVALID_OFFSET')
                        : invariant(false)
                      : void 0
                    !JSBI.greaterThan(limit, JSBI.BigInt(0))
                      ? process.env.NODE_ENV !== 'production'
                        ? invariant(false, 'INVALID_LIMIT')
                        : invariant(false)
                      : void 0
