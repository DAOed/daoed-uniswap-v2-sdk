 ...
 */
var WETH9 = (_WETH = {}, _WETH[exports.ChainId.SEPOLIA] = /*#__PURE__*/new Token(exports.ChainId.SEPOLIA, '0xfFf9976782d46CC05630D1f6eBAb18b2324d6B14', 18, 'WETH', 'Wrapped Ether'), _WETH);
...
function quote(amountA, reserveA, reserveB) {
  ...
  !(JSBI.greaterThan(reserveA, JSBI.BigInt(0)) && JSBI.greaterThan(reserveB, JSBI.BigInt(0))) ?  invariant(false, 'INSUFFICIENT_LIQUIDITY')  : void 0;
...
function getAmountOut(amountIn, reserveIn, reserveOut) {
  ...
  !(JSBI.greaterThan(reserveIn, JSBI.BigInt(0)) && JSBI.greaterThan(reserveOut, JSBI.BigInt(0))) ?  invariant(false, 'INSUFFICIENT_LIQUIDITY')  : void 0;
...
function computeProfitMaximizingTrade(truePriceTokenA, truePriceTokenB, reserveA, reserveB) {
  !(JSBI.greaterThan(truePriceTokenA, JSBI.BigInt(0)) && JSBI.greaterThan(truePriceTokenB, JSBI.BigInt(0))) ?  invariant(false, 'INVALID_PRICES')  : void 0;
  !(JSBI.greaterThan(reserveA, JSBI.BigInt(0)) && JSBI.greaterThan(reserveB, JSBI.BigInt(0))) ?  invariant(false, 'INSUFFICIENT_RESERVES')  : void 0;
...
function getReservesAfterArbitrage(reserveA, reserveB, truePriceTokenA, truePriceTokenB) {
  !(JSBI.greaterThan(reserveA, JSBI.BigInt(0)) && JSBI.greaterThan(reserveB, JSBI.BigInt(0))) ?  invariant(false, 'ZERO_PAIR_RESERVES')  : void 0;
...
function getLiquidityValueAfterArbitrageToPrice(pairReserves, truePriceTokenA, truePriceTokenB, liquidityAmount) {
  !(JSBI.greaterThanOrEqual(pairReserves.totalSupply, liquidityAmount) && JSBI.greaterThan(liquidityAmount, JSBI.BigInt(0))) ?  invariant(false, 'INVALID_LIQUIDITY_AMOUNT')  : void 0;
