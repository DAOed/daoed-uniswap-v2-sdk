...
var SUPPORTED_CHAINS = [exports.ChainId.SEPOLIA]
...
var FACTORY_ADDRESSES =
  ((_FACTORY_ADDRESSES = {}),
  (_FACTORY_ADDRESSES[exports.ChainId.SEPOLIA] = SEPOLIA_ADDRESSES.FACTORY),
  _FACTORY_ADDRESSES)
var ROUTER_ADDRESSES =
  ((_ROUTER_ADDRESSES = {}),
  (_ROUTER_ADDRESSES[exports.ChainId.SEPOLIA] = SEPOLIA_ADDRESSES.ROUTER02),
  _ROUTER_ADDRESSES)
  ...
  function f(e) {
    return (
      Object.setPrototypeOf
        ...
        : ((e.__proto__ = GeneratorFunctionPrototype), _regeneratorDefine(e, o, 'GeneratorFunction')),
...
var WETH9 =
  ((_WETH = {}),
  (_WETH[exports.ChainId.SEPOLIA] = /*#__PURE__*/ new Token(
...
var InsufficientReservesError = /*#__PURE__*/ (function(_Error) {
  function InsufficientReservesError() {
    ...
    if (CAN_SET_PROTOTYPE)
      Object.setPrototypeOf(_this, (this instanceof InsufficientReservesError ? this.constructor : void 0).prototype)
    return _this
  }
...
var Pair = /*#__PURE__*/ (function() {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    !factoryAddress ? invariant(false, 'FACTORY_ADDRESS') : void 0
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount, calculateFotFees) {
    ...
    var inputAmountAfterTax = percentAfterSellFees.greaterThan(ZERO_PERCENT)
    ...
    var outputAmountAfterTax = percentAfterBuyFees.greaterThan(ZERO_PERCENT)
      ? CurrencyAmount.fromRawAmount(
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount, calculateFotFees) {
    ...
    var percentAfterBuyFees = calculateFotFees ? this.derivePercentAfterBuyFees(outputAmount) : ZERO_PERCENT
    var outputAmountBeforeTax = percentAfterBuyFees.greaterThan(ZERO_PERCENT)
      ? CurrencyAmount.fromRawAmount(
          outputAmount.currency,
    ...
    var percentAfterSellFees = calculateFotFees ? this.derivePercentAfterSellFees(inputAmount) : ZERO_PERCENT
    var inputAmountBeforeTax = percentAfterSellFees.greaterThan(ZERO_PERCENT)
      ? CurrencyAmount.fromRawAmount(
          inputAmount.currency,
  ...
  _proto.derivePercentAfterSellFees = function derivePercentAfterSellFees(inputAmount) {
    var sellFeeBips = this.token0.wrapped.equals(inputAmount.wrapped.currency)
  ...
  _proto.derivePercentAfterBuyFees = function derivePercentAfterBuyFees(outputAmount) {
    var buyFeeBps = this.token0.wrapped.equals(outputAmount.wrapped.currency)
...
function sortTokens(tokenA, tokenB) {
  !(tokenA !== tokenB) ? invariant(false, 'IDENTICAL_ADDRESSES') : void 0
  var _ref = tokenA.toLowerCase() < tokenB.toLowerCase() ? [tokenA, tokenB] : [tokenB, tokenA],
    token0 = _ref[0],
    token1 = _ref[1]
  !(token0.toLowerCase() !== '0x0000000000000000000000000000000000000000') ? invariant(false, 'ZERO_ADDRESS') : void 0
...
function quote(amountA, reserveA, reserveB) {
  !JSBI.greaterThan(amountA, JSBI.BigInt(0)) ? invariant(false, 'INSUFFICIENT_AMOUNT') : void 0
  !(JSBI.greaterThan(reserveA, JSBI.BigInt(0)) && JSBI.greaterThan(reserveB, JSBI.BigInt(0)))
    ? invariant(false, 'INSUFFICIENT_LIQUIDITY')
    : void 0
...
function getAmountOut(amountIn, reserveIn, reserveOut) {
  !JSBI.greaterThan(amountIn, JSBI.BigInt(0)) ? invariant(false, 'INSUFFICIENT_INPUT_AMOUNT') : void 0
...
function getAmountIn(amountOut, reserveIn, reserveOut) {
  !JSBI.greaterThan(amountOut, JSBI.BigInt(0)) ? invariant(false, 'INSUFFICIENT_OUTPUT_AMOUNT') : void 0
  !(JSBI.greaterThan(reserveIn, JSBI.BigInt(0)) && JSBI.greaterThan(reserveOut, JSBI.BigInt(0)))
    ? invariant(false, 'INSUFFICIENT_LIQUIDITY')
    : void 0
...
function getAmountsOut(amountIn, reserves) {
  !(reserves.length >= 1) ? invariant(false, 'INVALID_PATH') : void 0
...
function computeProfitMaximizingTrade(truePriceTokenA, truePriceTokenB, reserveA, reserveB) {
  !(JSBI.greaterThan(truePriceTokenA, JSBI.BigInt(0)) && JSBI.greaterThan(truePriceTokenB, JSBI.BigInt(0)))
    ? invariant(false, 'INVALID_PRICES')
    : void 0
  !(JSBI.greaterThan(reserveA, JSBI.BigInt(0)) && JSBI.greaterThan(reserveB, JSBI.BigInt(0)))
    ? invariant(false, 'INSUFFICIENT_RESERVES')
    : void 0
...
function getReservesAfterArbitrage(reserveA, reserveB, truePriceTokenA, truePriceTokenB) {
  !(JSBI.greaterThan(reserveA, JSBI.BigInt(0)) && JSBI.greaterThan(reserveB, JSBI.BigInt(0)))
    ? invariant(false, 'ZERO_PAIR_RESERVES')
    : void 0
...
function getLiquidityValueAfterArbitrageToPrice(pairReserves, truePriceTokenA, truePriceTokenB, liquidityAmount) {
  !(
    ...
    ? invariant(false, 'INVALID_LIQUIDITY_AMOUNT')
    : void 0
  var _getReservesAfterArbi = getReservesAfterArbitrage(
      pairReserves.reserveA,
      pairReserves.reserveB,
      truePriceTokenA,
      truePriceTokenB
...
var MockLPDataProvider = /*#__PURE__*/ (function() {
  ...
  _proto.getUserLPPoolCount = /*#__PURE__*/ (function() {
    var _getUserLPPoolCount = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee(user) {
        var pools
  ...
  _proto.getUserLPPools = /*#__PURE__*/ (function() {
    var _getUserLPPools = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee2(user, offset, limit) {
  ...
  _proto.getUserLPBalance = /*#__PURE__*/ (function() {
    var _getUserLPBalance = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee3(user, pool) {
        var userBalances
        return _regenerator().w(
          function(_context3) {
            while (1)
  ...
  _proto.getUserLPPositions = /*#__PURE__*/ (function() {
    var _getUserLPPositions = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee4(user, offset, limit) {
            ...
            while (1)
              switch (_context4.n) {
                ...
                case 4:
                  ...
                  sharePercentage = JSBI.equal(poolInfo.totalSupply, JSBI.BigInt(0))
                    ? JSBI.BigInt(0)
  ...
  _proto.hasLPPosition = /*#__PURE__*/ (function() {
    var _hasLPPosition = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee5(user, pool) {
        var balance
        return _regenerator().w(
          function(_context5) {
            while (1)
  ...
  _proto.getPoolInfo = /*#__PURE__*/ (function() {
    var _getPoolInfo = /*#__PURE__*/ _asyncToGenerator(
      /*#__PURE__*/ _regenerator().m(function _callee6(pool) {
        var info
        return _regenerator().w(
          function(_context6) {
            while (1)
...
var LPPositionTracker = /*#__PURE__*/ (function() {
  ...
  _proto2.getUserLPPoolCount =
    /*#__PURE__*/
    (function() {
      var _getUserLPPoolCount2 = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee7(user) {
          return _regenerator().w(
            function(_context7) {
              while (1)
                switch (_context7.n) {
  ...
  _proto2.getUserLPPools =
    /*#__PURE__*/
    (function() {
      var _getUserLPPools2 = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee8(user, offset, limit) {
          return _regenerator().w(
            function(_context8) {
              while (1)
                switch (_context8.n) {
                  case 0:
                    !JSBI.greaterThanOrEqual(offset, JSBI.BigInt(0)) ? invariant(false, 'INVALID_OFFSET') : void 0
                    !JSBI.greaterThan(limit, JSBI.BigInt(0)) ? invariant(false, 'INVALID_LIMIT') : void 0
  ...
  _proto2.getUserLPBalance =
    /*#__PURE__*/
    (function() {
      var _getUserLPBalance2 = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee9(user, pool) {
          return _regenerator().w(
            function(_context9) {
              while (1)
                switch (_context9.n) {
  ...
  _proto2.getUserLPPositions =
    /*#__PURE__*/
    (function() {
      var _getUserLPPositions2 = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee0(user, offset, limit) {
          return _regenerator().w(
            function(_context0) {
              while (1)
                switch (_context0.n) {
  ...
  _proto2.hasLPPosition =
    /*#__PURE__*/
    (function() {
      var _hasLPPosition2 = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee1(user, pool) {
          return _regenerator().w(
            function(_context1) {
              while (1)
                switch (_context1.n) {
  ...
  _proto2.getAllUserLPPositions =
    /*#__PURE__*/
    (function() {
      var _getAllUserLPPositions = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee10(user) {
  ...
  _proto2.getUserTotalLPValue =
    /*#__PURE__*/
    (function() {
      var _getUserTotalLPValue = /*#__PURE__*/ _asyncToGenerator(
        /*#__PURE__*/ _regenerator().m(function _callee11(user) {
          var positions, pools
          return _regenerator().w(
            function(_context11) {
              while (1)
...
exports.LPPositionTracker = LPPositionTracker
exports.MINIMUM_LIQUIDITY = MINIMUM_LIQUIDITY
exports.MaxUint256 = MaxUint256
exports.MockLPDataProvider = MockLPDataProvider
...
exports._1000 = _1000
exports._997 = _997
exports.computeLiquidityValue = computeLiquidityValue
exports.computePairAddress = computePairAddress
exports.computePriceImpact = computePriceImpact
exports.computeProfitMaximizingTrade = computeProfitMaximizingTrade
...
exports.getLiquidityValueAfterArbitrageToPrice = getLiquidityValueAfterArbitrageToPrice
exports.getReservesAfterArbitrage = getReservesAfterArbitrage
exports.getRouterAddress = getRouterAddress
exports.inputOutputComparator = inputOutputComparator
exports.pairFor = pairFor
exports.quote = quote
exports.setFactoryAddress = setFactoryAddress
exports.setRouterAddress = setRouterAddress
exports.sortTokens = sortTokens
exports.sortedInsert = sortedInsert
exports.sqrt = sqrt
exports.tradeComparator = tradeComparator
exports.validateAndParseAddress = validateAndParseAddress
//# sourceMappingURL=uniswap-v2-sdk-core.cjs.development.js.map
